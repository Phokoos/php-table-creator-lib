    ...
    public function draw(TableData $tableData){
        ...
        if($tableData->pagination)
        {
            ...
            if ($tableData->currentPage > 1)
            {
                ...
                echo "<li class='page-item'><a class='page-link' href='?page=" . ($tableData->currentPage - 1) . "'>&laquo;</a></li>";
            }
            ...
            {
                echo "<li class='page-item'><a class='page-link' href='?page=" . ($tableData->currentPage + 1) . "'>&raquo;</a></li>";
